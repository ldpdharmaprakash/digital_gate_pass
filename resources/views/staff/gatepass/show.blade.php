...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-2">Review student gatepass request</p>
        </div>
        <a href="{{ route('staff.gatepasses.pending') }}" class="text-blue-600 hover:text-blue-800 flex items-center">
        ...
        <div class="p-6">
            ...
            @if($gatepass->canUserChangeDecision(Auth::user()) || $gatepass->canBeApprovedByStaff())
                <div class="mt-8 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Staff Approval Action</h3>
                    <form method="POST" action="{{ route('staff.gatepasses.approve', $gatepass) }}">
                        @csrf
                        <div class="space-y-4">
                            <div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="{{ route('staff.gatepasses.pending') }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">
                                    Cancel
                                </a>
                            </div>
                        </div>
