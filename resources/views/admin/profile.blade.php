        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div class="ml-6">
                    ...
                    <p class="text-sm text-gray-600">System Administrator • {{ auth()->user()->email }}</p>
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ auth()->user()->updated_at->format('M d, Y h:i A') }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Total Users Managed</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ \App\Models\User::count() }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
