            ...
            <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <div class="flex space-x-3">
                    @if($gatepass->isFinalApproved())
                        ...
                        <a href="{{ route('gatepass.qr.generate', $gatepass) }}" target="_blank" class="px-4 py-2 border border-purple-300 text-purple-700 rounded-lg hover:bg-purple-50 transition-colors flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
