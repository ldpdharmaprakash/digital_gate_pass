...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-2">View department gatepass statistics and analytics</p>
        </div>
        <a href="{{ route('hod.reports.download') }}" class="btn-primary px-6 py-3 text-white rounded-lg flex items-center">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div class="flex items-center">
                    ...
                    <span class="text-sm font-medium text-gray-700">Staff Approved</span>
                </div>
                <span class="text-sm font-bold text-gray-900">{{ $statusStats['staff_approved'] }}</span>
            </div>
