...
@section('title', 'HOD Profile')

@section('content')
<div class="max-w-4xl mx-auto">
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">HOD Profile</h1>
        <p class="text-gray-600 mt-2">Department Head profile and information</p>
    </div>
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="w-20 h-20 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 flex items-center justify-center text-white text-2xl font-bold">
                        {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                    </div>
                </div>
                <div class="ml-6">
                    <h2 class="text-2xl font-bold text-gray-900">{{ auth()->user()->name }}</h2>
                    <p class="text-sm text-gray-600">Head of Department • {{ auth()->user()->email }}</p>
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ auth()->user()->hod->department->code }}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Staff Members</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ auth()->user()->hod->department->staff()->count() }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
