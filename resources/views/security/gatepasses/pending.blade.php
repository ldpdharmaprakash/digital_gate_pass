...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pending Gatepasses</h1>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('security.gatepasses.pending') }}">
    ...
    <!-- Pending Gatepasses Table -->
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-warning">Pending Gatepasses</h6>
                    <span class="badge bg-warning">{{ $gatepasses->total() }} Pending</span>
                </div>
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-gray-500">No pending gatepasses</h5>
                            <p class="text-gray-400">All gatepasses have been processed.</p>
                        </div>
                    @endif
                </div>
            </div>
